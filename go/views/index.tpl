...
<link href="https://cdnjs.cloudflare.com/ajax/libs/amazeui/2.7.2/css/amazeui.min.css" rel="stylesheet" type="text/css">
<style>
	.floatno{
							...
							<table class="am-table am-table-striped am-table-hover table-main">
								<tbody>
									<tr v-for="movieInfo in list">
										...
										<td v-text="movieInfo.name" v-bind:title="movieInfo.ed2k"></td>
